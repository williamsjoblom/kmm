...
Matrix.fromMatrix = function(m) {
	...
	matrix.setTransform(m.a, m.b, m.c, m.d, m.e, m.f);
	return matrix;
};
...
Matrix.prototype = {
	...
	/**
	 * Save current transform of context.
	 * @returns {Matrix}
	 */
	save: function() {
		var me = this;
		me.stack.push([me.a,me.b,me.c,me.d,me.e,me.f]);
		return me;
	},

	/**
	 * Restore transform that was last saved to stack.
	 * @returns {Matrix}
	 */
	restore: function(tx, ty) {
		var me = this;
		if (me.stack.length > 0) {
			var lt = me.stack.pop();
			me.setTransform.apply(me, lt);
		} else {
			console.error("No transform on stack!");
		}
		return me;
	},
